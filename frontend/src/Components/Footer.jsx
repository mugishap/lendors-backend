...
const Footer = () => {
    return (
        <div className='bg-[#161616]/90  py-14 text-white font-poppins w-full flex items-start justify-around'>
            ...
            <div className='flex flex-col items-start w-1/4'>
                ...
                <div className='flex items-center justify-between w-full'>
                    <input type="text" className='w-3/4 px-3 py-2 rounded-l-md border border-gray-300 focus:outline-none focus:ring-2' placeholder='Enter your email' />
                    <button className='bg-blue-600 text-white px-3 py-2 rounded-r-md font-poppins font-medium'>Subscribe</button>
                </div>
